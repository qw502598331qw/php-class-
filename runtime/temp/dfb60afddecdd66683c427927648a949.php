<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\PHPstudy\PHPTutorial\WWW\class\public/../application/admin\view\article\add.htm";i:1520388793;s:81:"D:\PHPstudy\PHPTutorial\WWW\class\public/../application/admin\view\common\top.htm";i:1521026509;s:82:"D:\PHPstudy\PHPTutorial\WWW\class\public/../application/admin\view\common\left.htm";i:1521199053;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>实验室管理系统</title>
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('article/lst'); ?>">公告管理</a>
                    </li>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增公告</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">公告标题</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">公告作者</label>
                            <div class="col-sm-6">
