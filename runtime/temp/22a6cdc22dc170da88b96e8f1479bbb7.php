<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\PHPstudy\PHPTutorial\WWW\class\public/../application/admin\view\login\login.htm";i:1520386895;}*/ ?>
<!DOCTYPE html>
        ...
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="loginbox-textbox">
                    <input  class="form-control" placeholder="请输入用户" name="username" type="text">
                </div>
                <div class="loginbox-textbox">
